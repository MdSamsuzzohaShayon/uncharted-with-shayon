                    ...
                    <div class="flex flex-col lg:flex-row gap-12">
                        ...
                        <div class="lg:w-8/12">
                            <!-- <div class="prose prose-lg max-w-none article-content"
                                v-html="renderMarkdown(article.content)"></div> -->

                            <ClientOnly>
                                <!-- Use EditorJsRenderer -->
                                <EditorJsRenderer v-if="article.content" :content="article.content"
...
// Preload Editor.js as early as possible
if (import.meta.client) {
    // Start loading Editor.js immediately
...
useSeoMeta({
    ...
    description: () => article.value?.meta_description || article.value?.content?.substring(0, 160) || '',
    ogTitle: () => article.value?.meta_title || article.value?.title,
    ogDescription: () => article.value?.meta_description || article.value?.content?.substring(0, 160) || '',
